        ...
        return (
            <div className="text-center playerGame">
                <div className="theThink">
                    ...
                    <img style={{ transform: 'rotate(360deg)' }} className="mt-3" width={100} height={100} src={this.props.mangDatCuoc.find(item => item.datCuoc === true).hinhAnh} alt={this.props.mangDatCuoc.find(item => item.datCuoc === true).hinhAnh} />
                </div>
